...
def dcm2png(dcm_path, label_path):
    ...
    save_data = r'C:\\Users\\76930\\Desktop\\unet\\3DIRCADB\\test\\images'
    save_lab = r'C:\\Users\\76930\\Desktop\\unet\\3DIRCADB\\test\\2nd_manual'
    ...
    for lab in labellist:
        ...
        img_path=os.path.join(save_data, lab+'.png')
        lab_path=os.path.join(save_lab, lab+'.png')
        print(img_path)
        print(lab_path)
...
if __name__ == "__main__":
    ...
    # 批量dcm转png
    dcm_pa = r'D:\\BaiduNetdiskDownload\\3Dircadb1.3\\PATIENT_DICOM'
    lab_dcm = r'D:\\BaiduNetdiskDownload\\3Dircadb1.3\\MASKS_DICOM\\liver'
